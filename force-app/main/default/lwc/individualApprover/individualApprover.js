...
export default class individualApprover extends NavigationMixin(
  LightningElement
) {
  @api recordId;
  @api quote;
  ...
  handleClickApproveProcess() {
    sendForApproval({ groupId: this.recordId, comments: this.comments, isApproval: true })
      .then(() => {
        this.dispatchEvent(
          new ShowToastEvent({
            title: "Éxito",
  ...
  handleClickRejectProcess() {
    sendForApproval({ groupId: this.recordId, comments: this.comments, isApproval: false })
      .then(() => {
        this.dispatchEvent(
          new ShowToastEvent({
            title: "Éxito",
